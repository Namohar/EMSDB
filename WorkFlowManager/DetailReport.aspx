<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailReport.aspx.cs" Inherits="WorkFlowManager.DetailReport" %>
...
<body>
    ...
    <fieldset style="border-style: double; border-color: #0066FF; background-color: #f6f6f6;
        ...
        <asp:GridView ID="GrdDetails"  runat="server" Visible="true" AutoGenerateColumns="false">
            <Columns>
                <asp:BoundField DataField="FI_ReceiptDate" HeaderText="FI_ReceiptDate" DataFormatString="{0:MM/dd/yyyy}" />
            <asp:BoundField DataField="FI_ClientCode" HeaderText="FI_ClientCode"/> 
               <asp:BoundField DataField="IND_IP_Processed_By" HeaderText="Processed_By"/>
                <asp:BoundField DataField="Log_NewValue" HeaderText="InvoiceNumber" DataFormatString="{0:d}" />
        ...
        <div>
         <%--   <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                OnDataBinding="CrystalReportViewer1_DataBinding" Height="50px" 
                Width="350px" />--%>
            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" />
        </div>
