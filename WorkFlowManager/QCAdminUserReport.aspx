<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QCAdminUserReport.aspx.cs"
    Inherits="WorkFlowManager.QCAdminUserReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                OnDataBinding="CrystalReportViewer1_DataBinding" />
            <%--    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"/>--%>
        </ContentTemplate>
    </asp:UpdatePanel>
