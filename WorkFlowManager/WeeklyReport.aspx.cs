            ...
            try
            {
                if (datepickerfrom.Text != "" && datepickerTo.Text != "")
                {
                    ...
                    if (dates != false)
                    {
                        ...
                        DataTable pendingReport = GetData("select RECEIVEDATE,Pending,Issue from REPORT");
