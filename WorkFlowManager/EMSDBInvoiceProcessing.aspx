<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="EMSDBInvoiceProcessing.aspx.cs" Inherits="WorkFlowManager.EMSDBInvoiceProcessing" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
                <i class="fa fa-file-o"></i>IP Invoices</h3>
            <ol class="breadcrumb">
                ...
                <asp:TextBox ID="search_textbox" runat="server" placeholder="Search" AutoPostBack="True"
                    OnTextChanged="search_textbox_TextChanged"></asp:TextBox>
                <%-- <input id="btnSearch" runat="server"  OnClick="btnSearch_Click1" type="button"
                    value="Search" />--%>
                <asp:Button ID="btnUpload" runat="server" Text="Search" OnClick="btnSearch_Click1"
                    OnClientClick="showProgress()" />
                <input id="btnReset" runat="server" onserverclick="btnReset_Click1" type="button"
                    value="Reset" />
                <input id="btnExport" runat="server" onserverclick="btnExport_Click1" type="button"
                    value="Export" />
                <asp:UpdatePanel runat="server" ID="updatepanel1" UpdateMode="Conditional">
                    <ContentTemplate>
                        <%--<div style="align:center; margin-left:350px; margin-top:200px">--%>
                        <%--<asp:Button ID="btnUpload1" Text="Upload" runat="server" onclick="btnSearch_Click1" OnClientClick="showProgress()" /><br />--%>
                        <%--</div>--%>
                    </ContentTemplate>
                    <Triggers>
                            ...
                            <asp:UpdatePanel ID="EmployeesUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="gvIPInvoices" runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered table-hover"
                                        ...
                                        OnRowUpdating="gvIPInvoices_RowUpdating" DataKeyNames="FI_ID" Font-Size="Smaller">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Invoice#">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtInvoiceNo" runat="server" Visible="False" MaxLength="30"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Process">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:DropDownList ID="ddlprocess" runat="server" AutoPostBack="true" Visible="false">
                                                        <asp:ListItem Text="IP_Inp" Value="0"></asp:ListItem>
        ...
        <ContentTemplate>
            ...
            <div id="divPopUp" class="modalPopup" style="display: none">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left">
                                <asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" Width="228px" MaxLength="500"
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="200px" UpdateMode="Conditional">
                ...
                <div class="footer" align="right">
                    ...
                    <%--  <input id="btnNo" runat="server" onserverclick="btnNo_Click" type="button"  CssClass="no"
                    value="Cancel" />--%>
