<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryReport.aspx.cs" 
    Inherits="WorkFlowManager.SummaryReport" %>
 ...
 <h1>Summary Report</h1>
    ...
    <div>
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                    OnDataBinding="CrystalReportViewer1_DataBinding" Height="50px" Width="350px" />
    </div>
   ...
   <%-- <script type="text/javascript">
        $(function () {
            $("#datepickerfrom").datepicker({ maxDate: new Date() });
        });
