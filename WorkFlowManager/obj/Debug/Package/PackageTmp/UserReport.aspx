<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserReport.aspx.cs" Inherits="WorkFlowManager.UserReport" %>
...
<body>
    ...
    <fieldset style="border-style: double; border-color: #0066FF; background-color: #f6f6f6">
        <div>
                ...
                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" ondatabinding="CrystalReportViewer1_DataBinding" height="50px" width="350px" />
        </div>
